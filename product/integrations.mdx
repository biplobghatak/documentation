...
![Integration Settings](/images/Integration-settings.png "Integration Settings")
...
<CardGroup cols={2}>
  ...
  <Card title="Shopify" icon="shopify">
    Push articles straight to your Shopify blog.
  </Card>
...
<Steps>
  ...
  <Step title="Publish">
    Now, when you finish an article in the [AI writer](/product/writer), you can publish it straight to your site.
  </Step>
</Steps>
...
<Steps>
  <Step title="Enter your Shopify store address">
    In Spyro, open **Content settings → Integrations**, choose **Shopify**, and enter your store address (for example, `my-store.myshopify.com`).
  </Step>
  <Step title="Connect with Shopify">
    Click **Continue with Shopify** and approve the permissions. Spyro publishes articles straight to your Shopify blog via the Admin API.
  </Step>
  <Step title="Publish">
    Now, when you finish an article in the [AI writer](/product/writer), you can publish it straight to your Shopify store.
  </Step>
</Steps>
...
Connect **Google Search Console** to bring your real Google search performance into Spyro - clicks, impressions, and the pages and searches that bring you visitors. See [Google Search Console](/product/search-console) for the simple sign-in steps.

You can also connect **Google Analytics 4** to track AI-driven referral traffic - visitors who reached your site from ChatGPT, Perplexity, Gemini, Claude, and other AI engines.
