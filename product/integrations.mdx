...
Connect **Google Search Console** to bring your real Google search performance into Spyro - clicks, impressions, and the pages and searches that bring you visitors. See [Google Search Console](/product/search-console) for the simple sign-in steps. (Google Analytics support is coming soon.)
