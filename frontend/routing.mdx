...
flowchart TD
  ...
  app --> reports["report pages: /pdf-report, /ai-readiness-report, /schema-report, /invite/[token]"]
  ...
  sadmin --> spanel["(panel)/ → orgs · users · workspaces · usage · billing · cost · audit-log"]
```
